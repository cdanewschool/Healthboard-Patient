package ASclasses
{
	...
	public class MyCircleItemRendererExSlider extends CircleItemRenderer
	{
		private static var rcFill:Rectangle = new Rectangle();
		private var _data:Object;
		
		public function MyCircleItemRendererExSlider()
		{
			super();
		}
													  ...
													  unscaledHeight:Number):void
		{
			...
			if(_data.item.index != FlexGlobals.topLevelApplication.exerciseData.length - 1) {
				...
				stroke = new SolidColorStroke(0xFF0000,1);
			}
